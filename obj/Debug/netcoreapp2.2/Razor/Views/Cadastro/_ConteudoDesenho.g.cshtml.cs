#pragma checksum "/home/johnatas/Documentos/Projetos/MoveIlheus/Views/Cadastro/_ConteudoDesenho.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "0c757fbf652d83a1ebd009f74d0b4b1e5007d178"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"0c757fbf652d83a1ebd009f74d0b4b1e5007d178", @"/Views/Cadastro/_ConteudoDesenho.cshtml")]
        ...
        <div class=""modal-content"">
            ...
            <div class=""modal-body"">
                <div v-if=""conteudoEditando != -1"">
                    <draggable :list=""formulario.paginas[paginaAtual].conteudos[conteudoEditando].conteudosDesenhos"" :options=""{handle:'.handle'}"" v-on:change=""formulario.paginas[paginaAtual].conteudos[conteudoEditando].atualizarSe");
            WriteLiteral(@"quenciaConteudosDesenho()"" style=""width: 100%;"">
                        <div v-for=""(conteudo, index) in formulario.paginas[paginaAtual].conteudos[conteudoEditando].conteudosDesenhos"" class=""list-group-item"">
                            <h5 class=""questionHeader col-sm-12"" style=""z-index: 1;"">
                                <span style=""float: right;"" v-if=""conteudoDesenhoEditando == index || conteudoDesenhoEditando == -1"">
                                    ...
                                    <span v-if=""index != conteudoDesenhoEditando"" class=""fa fa-edit btnEdit"" v-on:click=""conteudoDe");
            WriteLiteral(@"senhoEditando = index""></span>
...
#line 25 "/home/johnatas/Documentos/Projetos/MoveIlheus/Views/Cadastro/_ConteudoDesenho.cshtml"
                       Write(Html.Partial("_ConteudosDesenho"));

#line default
#line hidden
            EndContext();
            BeginContext(2571, 1110, true);
            WriteLiteral(@"
                        </div>
                    </draggable>
